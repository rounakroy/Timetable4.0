...
namespace Timetable
{
    public partial class monday : System.Web.UI.Page
    {
        ...
        protected void CustomValidator2_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time1='" + DropDownList15.SelectedItem.Text + "' and teacher1='" + DropDownList9.SelectedItem.Text + "'", con);
      ...
      //        if (count1 == 1 && count == 1 && c == 2)
                ...
                if (DropDownList1.SelectedItem.Text != "Select")
                {
                    ...
                    if (theory.Checked == true || lab.Checked == true)
                    {
                        ...
                        if (DropDownList1.SelectedItem.Text == "CS8")
                        {
                            ...
                            if (next == 2)
                            {
                                Response.Redirect("~/SavePage/Days/tuesday.aspx");
       ...
       /* protected void CustomValidator123_ServerValidate(object source, ServerValidateEventArgs args)
        ...
        protected void CustomValidator3_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time2='" + DropDownList16.SelectedItem.Text + "' and teacher2='" + DropDownList12.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator4_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time3='" + DropDownList17.SelectedItem.Text + "' and teacher3='" + DropDownList14.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator5_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time='" + DropDownList2.SelectedItem.Text + "' and teacher='" + DropDownList5.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator6_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time='" + DropDownList2.SelectedItem.Text + "' and assisstant='" + DropDownList6.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator7_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time='" + DropDownList2.SelectedItem.Text + "' and labno='" + DropDownList3.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator8_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time1='" + DropDownList15.SelectedItem.Text + "' and classno='" + DropDownList7.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator9_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time2='" + DropDownList16.SelectedItem.Text + "' and classno='" + DropDownList7.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator10_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Monday where time3='" + DropDownList17.SelectedItem.Text + "' and classno='" + DropDownList7.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
