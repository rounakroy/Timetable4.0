<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="monday.aspx.cs" Inherits="Timetable.monday" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <asp:Label ID="Mondaydetails" runat="server" Text="Monday"></asp:Label>
