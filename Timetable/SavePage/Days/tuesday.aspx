<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="tuesday.aspx.cs" Inherits="Timetable.tuesday" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <asp:Label ID="Tuesdaydetails" runat="server" Text="Tuesday"></asp:Label>
