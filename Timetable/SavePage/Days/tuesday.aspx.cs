...
namespace Timetable
{
    public partial class tuesday : System.Web.UI.Page
    {
        ...
        protected void CustomValidator2_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time1='" + DropDownList15.SelectedItem.Text + "' and teacher1='" + DropDownList9.SelectedItem.Text + "'", con);
            ...
            if (flag == 1)
            {
                if (DropDownList1.SelectedItem.Text != "Select")
                {
                    ...
                    if (theory.Checked == true || lab.Checked == true)
                    {
                        ...
                        cm.CommandType = CommandType.Text;
                        if (theory.Checked == true)
                            cm.CommandText = "IF NOT EXISTS (select * from tuesday where section='" + DropDownList1.SelectedItem.Text + "') Insert into Tuesday (section,classno,time1,t1,teacher1,time2,t2,teacher2,time3,t3,teacher3) values ('" + DropDownList1.SelectedItem.Text + "','" + DropDownList7.SelectedItem.Text + "','" + DropDownList15.SelectedItem.Text + "','" + DropDownList8.SelectedItem.Text + "','" + DropDownList9.SelectedItem.Text + "','" + DropDownList16.SelectedItem.Text + "','" + DropDownList11.SelectedItem.Text + "','" + DropDownList12.SelectedItem.Text + "','" + DropDownList17.SelectedItem.Text + "','" + DropDownList13.SelectedItem.Text + "','" + DropDownList14.SelectedItem.Text + "') else Update Tuesday set classno2='" + DropDownList7.SelectedItem.Text + "',time4='" + DropDownList15.SelectedItem.Text + "',t4='" + DropDownList8.SelectedItem.Text + "',teacher4='" + DropDownList9.SelectedItem.Text + "',time5='" + DropDownList16.SelectedItem.Text + "',t5='" + DropDownList11.SelectedItem.Text + "',teacher5='" + DropDownList12.SelectedItem.Text + "',time6='" + DropDownList17.SelectedItem.Text + "',t6='" + DropDownList13.SelectedItem.Text + "',teacher6='" + DropDownList14.SelectedItem.Text + "' where section='" + DropDownList1.SelectedItem.Text + "'";
                        if (lab.Checked == true)
                            cm.CommandText = "IF NOT EXISTS (select * from tuesday where section='" + DropDownList1.SelectedItem.Text + "') Insert into Tuesday (section,labno,time,sub,teacher,assisstant) values ('" + DropDownList1.SelectedItem.Text + "','" + DropDownList3.SelectedItem.Text + "','" + DropDownList2.SelectedItem.Text + "','" + DropDownList4.SelectedItem.Text + "','" + DropDownList5.SelectedItem.Text + "','" + DropDownList6.SelectedItem.Text + "') else Update Tuesday set labno='" + DropDownList3.SelectedItem.Text + "',time='" + DropDownList2.SelectedItem.Text + "',sub='" + DropDownList4.SelectedItem.Text + "',teacher='" + DropDownList5.SelectedItem.Text + "',assisstant='" + DropDownList6.SelectedItem.Text + "'where section='" + DropDownList1.SelectedItem.Text + "'";
                        cm.ExecuteNonQuery();
                        con.Close();
                        if (DropDownList1.SelectedItem.Text == "CS8")
                        {
                            ...
                            if (next == 2)
                            {
                                Response.Redirect("~/SavePage/Days/wednesday.aspx");
        ...
        protected void CustomValidator3_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time2='" + DropDownList16.SelectedItem.Text + "' and teacher2='" + DropDownList12.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator4_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time3='" + DropDownList17.SelectedItem.Text + "' and teacher3='" + DropDownList14.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator5_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time='" + DropDownList2.SelectedItem.Text + "' and teacher='" + DropDownList5.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator6_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time='" + DropDownList2.SelectedItem.Text + "' and assisstant='" + DropDownList6.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator7_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time='" + DropDownList2.SelectedItem.Text + "' and labno='" + DropDownList3.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator8_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time1='" + DropDownList15.SelectedItem.Text + "' and classno='" + DropDownList7.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator9_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time2='" + DropDownList16.SelectedItem.Text + "' and classno='" + DropDownList7.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        protected void CustomValidator10_ServerValidate(object source, ServerValidateEventArgs args)
        {
            ...
            SqlConnection con = new SqlConnection(cs);
            con.Open();
            SqlCommand cmd = new SqlCommand("Select * from Tuesday where time3='" + DropDownList17.SelectedItem.Text + "' and classno='" + DropDownList7.SelectedItem.Text + "'", con);
            SqlDataReader dr = cmd.ExecuteReader();
