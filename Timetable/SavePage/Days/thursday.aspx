<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="thursday.aspx.cs" Inherits="Timetable.thursday" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <asp:Label ID="Thursdaydetails" runat="server" Text="Thursday"></asp:Label>
