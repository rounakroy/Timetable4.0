<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="friday.aspx.cs" Inherits="Timetable.friday" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <asp:Label ID="Fridaydetails" runat="server" Text="Friday"></asp:Label>
